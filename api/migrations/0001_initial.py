# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-24 07:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brownbag', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.Brownbag')),
        ...
        migrations.AddField(
            model_name='group',
            name='hangout',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='api.Hangout'),
        ),
        migrations.AddField(
            model_name='group',
            name='members',
